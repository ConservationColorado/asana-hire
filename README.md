...
<div align="center">
    ...
    <p>Here's a quick demo of the application, including pages for individual jobs and candidate management.</p>
    <img width="800"  src="docs/example-demographics.png" alt="Example demographics dashboard populated by the application">
    <p>Here's an example of an anonymized and confidential demographics dashboard populated by the application.</p>
</div>
